...
public class Needle extends GameEntity {

    private TextureAtlas atlas;
    
    public Body body;

    private AtlasRegion needle;

    public Needle(float width, float height, Body body) {
        super(width, height, body);
        
        this.atlas = new TextureAtlas("items/item.atlas");
        this.needle = atlas.findRegion("needleItem"); 
